...
function gif(){
  document.getElementById("food_wrapper").innerHTML = `<svg width="200px" height="200px" margin:"auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="lds-lds-clock">
...
function getList(){
  ...
  //  if(this.readyState == !4 && this.status == !200){
    //   document.getElementById("food_wrapper").innerHTML = `<svg width="200px" height="200px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="lds-lds-clock">
    //   <g transform="translate(50 50)">
    //     <g ng-attr-transform="scale({{config.scale}})" transform="scale(0.8)">
    //       <g transform="translate(-50 -50)">
    //         <path ng-attr-fill="{{config.c1}}" ng-attr-stroke="{{config.c1}}" ng-attr-stroke-width="{{config.width}}" d="M50,14c19.85,0,36,16.15,36,36S69.85,86,50,86S14,69.85,14,50S30.15,14,50,14 M50,10c-22.091,0-40,17.909-40,40 s17.909,40,40,40s40-17.909,40-40S72.091,10,50,10L50,10z" fill="#ff0000" stroke="#ff0000" stroke-width="3"></path>
